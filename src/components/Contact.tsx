const socials = [
  {
    label: "GitHub",
    href: "https://github.com/visionEye0",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/happy-coder",
    icon: (
  ...
  {
    label: "Email",
    href: "mailto:pranavsayshii@gmail.com",
    icon: (
  ...
  return (
    <section id="contact" className="relative mx-auto max-w-6xl px-6 pb-16 pt-28">
      ...
      <footer className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 text-sm text-zinc-500 sm:flex-row">
        <p>
          © {new Date().getFullYear()} Pranav Krishna. Crafted with{" "}
