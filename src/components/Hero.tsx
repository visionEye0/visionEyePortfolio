    ...
    <section id="top" className="relative flex min-h-screen flex-col items-center justify-center px-6 pt-24 pb-16">
      <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        <h1 className="font-display text-5xl font-extrabold leading-[1.05] tracking-tight sm:text-7xl md:text-8xl">
          ...
          <span className="text-gradient block">Pranav Krishna</span>
        </h1>
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-zinc-400 sm:text-lg">
          I craft high-performance web applications, AI-powered tools, and automated workflows. With experience in turning ambitious ideas into scalable, production-ready software and securing critical systems.
        </p>
